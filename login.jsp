...
<meta name="msapplication-TileImage"
	/content="/content/images/ico/ms-icon-144x144.jpg">
...
<div class="col-sm-4 shadow-lg p-5 mt-5 border-warning rounded">



<form action="logincheck.jsp"  method="post" class="mt-0" >
<a href="index.jsp" class="text-danger"><i class="far fa-arrow-alt-circle-left fa-3x"></i></a>
<a href="index.jsp"><img src="content/images/logo.jpg" class=" mx-auto d-block" alt="logo" height="100px" width="50%"></a><br>

<br><h3 class="fw-bolder fs-3"><center>Login Here</center></h3><br>


<div class="form-group col-md-12 fs-3">
...
<input  type="submit" value="Login" class="btn btn-danger fs-3 ">
</div>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.min.js" integrity="sha384-cVKIPhGWiC2Al4u+LWgxfKTRIcfu0JTxR+EQDz/bgldoEyl4H0zUF0QKbrJ0EcQF" crossorigin="anonymous"></script>
	...
	<a href="enquiry_form.jsp" style="background: #FE980F; color: #000;"
		class="float" target="_blank"><i class="fas fa-quetion my-float"></i></a>
